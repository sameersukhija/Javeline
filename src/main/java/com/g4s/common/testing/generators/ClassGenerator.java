...
import com.g4s.common.testing.exceptions.DataModelException;
import com.g4s.common.testing.exceptions.IOFileException;
import com.g4s.common.testing.io.IOFileUtils;
import com.g4s.common.testing.model.DataModel;
		...
		try {
			...
			while( table_names.hasNext() ){
	        	...
	        	if( add_annotation ) { 
	        		...
	        		importClasses.append( "import com.lumata.common.testing.annotations.mysql.Column;\n" );
	        	}
