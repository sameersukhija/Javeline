...
public class CatalogOfferPriceDAOList {

	private ArrayList<CatalogOfferPriceDAO> list;
	
	public CatalogOfferPriceDAOList() {
		
		this.list = new ArrayList<CatalogOfferPriceDAO>();
	...
	public int delete( Environment env, String tenant, ArrayList<Integer> filteredIds, CatalogOfferContentDAO catalogOfferContentDAO ) {
		...
		String query = "DELETE FROM " + tenant + ".catalog_offer_price;";
