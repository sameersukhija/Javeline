...
public class CatalogOffersDAOList {

	private ArrayList<CatalogOffersDAO> list;
	
	public CatalogOffersDAOList() {
		
		this.list = new ArrayList<CatalogOffersDAO>();
	...
	public int delete( Environment env, String tenant, ArrayList<Integer> filteredIds, CatalogOfferContentDAO catalogOfferContentDAO ) {
		...
		String query = "DELETE FROM " + tenant + ".catalog_offers;";
