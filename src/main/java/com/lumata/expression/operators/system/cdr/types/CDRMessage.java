...
public class CDRMessage extends CDR { 
	...
	@Sms( position = 3 )
	public String getSms() throws CDRException  {
		return super.getSms();
	}
	...
	public void setSmsStrategyRandom() throws CDRException  {
		super.setSmsStrategyRandom();
	}

	public void cleanSmsStrategyFixed()  {
		super.cleanSmsStrategyFixed() ;
	}

	public void cleanSmsStrategyIncrement()  {
		super.cleanSmsStrategyIncrement() ;
	}

	public void cleanSmsStrategyRandom()  {
		super.cleanSmsStrategyRandom() ;
	}
