...
public class CDRVoucher extends CDR { 
	...
	public void setVoucherCodeStrategyRandom( int length ) throws CDRException  {
	...
	public String getLocation() throws CDRException  {
		return this.location.getSchemaTable();
	}

	public void setLocationValues( final JSONObject dataSource ) throws CDRException  {
		if( this.location != null ) { this.location.setSchemaTableValues( dataSource ); }
	}

	public void setLocationStrategyFixed( final String field_value ) throws CDRException  {
		if( this.location != null ) { this.location.setSchemaTableStrategyFixed( field_value ); }
	}

	public void setLocationStrategyFixed( final int row ) throws CDRException  {
		if( this.location != null ) { this.location.setSchemaTableStrategyFixed( row ); }
	}

	public void cleanLocationStrategyIncrement()  {
		if( this.location != null ) { this.location.cleanSchemaTableStrategyIncrement() ; }
	}

	public void cleanLocationStrategyRandom()  {
		if( this.location != null ) { this.location.cleanSchemaTableStrategyRandom() ; }
	}

	public void setLocationStrategyIncrement( final Integer start_row, final Integer increment ) throws CDRException  {
		if( this.location != null ) { this.location.setSchemaTableStrategyIncrement( start_row, increment ); }
	}

	public void setLocationStrategyRandom() throws CDRException  {
		if( this.location != null ) { this.location.setSchemaTableStrategyRandom(); }
	}

	public void cleanLocationOptions()  {
		if( this.location != null ) { this.location.cleanSchemaTableOptions() ; }
	}

	public void cleanLocationStrategyFixed()  {
		if( this.location != null ) { this.location.cleanSchemaTableStrategyFixed() ; }
	}
