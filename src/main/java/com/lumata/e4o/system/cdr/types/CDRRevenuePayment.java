...
public class CDRRevenuePayment extends CDR { 
	...
	public void setAmountPaymentStrategyFixed( final Long value ) throws CDRException  {
	...
	public void setAmountPaymentStrategyIncrement( final Long value, final Integer increment ) throws CDRException  {
		if( this.amount_payment != null ) { this.amount_payment.setLongStrategyIncrement( value, increment ); }
	}

	public void setAmountPaymentStrategyRandom( final Long min_value, final Long max_value ) throws CDRException  {
	...
	public String getAmountPayment() throws CDRException  {
