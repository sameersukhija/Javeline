...
public class GenerateXMLRPCAllocateThread implements Runnable {
	...
	public GenerateXMLRPCAllocateThread( int threadId, int p, long sleep, Server guiServer, User superman, Long msisdn, ArrayList<Token> tokens ) {
