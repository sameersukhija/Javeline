...
public final class DialogManagerMessageUtils {
	...
	public static DialogManagerMessage newValidDialogManagerMessage(Long messageId, Long tenantId)
		...
		return newValidDialogManagerMessage(SMS_RECEIVER, messageId, tenantId);
		
	}

	public static DialogManagerMessage newValidDialogManagerMessage(String msisdn, Long messageId, Long tenantId)
			throws ParseException {
		fillNotifLog();
		fillTimeWindowList();
