...
public class DatePickerForm extends Form {
	...
	private static final Logger logger = LoggerFactory.getLogger(DatePickerForm.class);

	private enum DatePickerMonth {
	...
	*/
	...
	public DatePickerForm open( String xpath ) throws FormException {
	...
	public DatePickerForm set( String date ) throws FormException {
	...
	public DatePickerForm setYearMonth( Calendar date ) throws Exception {
		
		String datePickerPreviousButtonXPAth = "//table[@class='gwt-DatePicker']//div[@class='datePickerPreviousButton datePickerPreviousButton-up']";
		String datePickerNextButtonXPAth = "//table[@class='gwt-DatePicker']//div[@class='datePickerNextButton datePickerNextButton-up']";
		
		String dateStr = getTextByXPath( "//table[@class='gwt-DatePicker']//td[@class='datePickerMonth']" );
		
		String[] ym = dateStr.split( " " );
		
		Calendar currentDate = Calendar.getInstance();
		
		currentDate.set( Calendar.YEAR, Integer.valueOf( ym[ 0 ] ) );
		currentDate.set( Calendar.MONTH, DatePickerMonth.valueOf( ym[ 1 ] ).ordinal() );
	...
	/*
	public DatePickerForm addCampaigns() throws FormException, JSONException {
...
*/	
/*	public DatePickerForm configureCampaign() throws FormException, JSONException {
	...
	public DatePickerForm configureCampaignDefinition() throws FormException, JSONException {
	...
	public DatePickerForm configureCampaignScheduling() throws FormException, JSONException {
	...
	public DatePickerForm configureCampaignSingleScheduling() throws FormException, JSONException {
	...
	public DatePickerForm configureCampaignMultipleScheduling() throws FormException, JSONException {
...
/*		return this;
	...
	public DatePickerForm configureCampaignDialogue() throws FormException, JSONException {
	...
	public DatePickerForm configureCampaignTarget() throws FormException, JSONException {
	...
	public DatePickerForm configureCampaignLimits() throws FormException, JSONException {
	...
	public DatePickerForm configureCampaignActivation() throws FormException, JSONException {
...
/*	private Boolean isActive() throws JSONException {
	...
	@Override
	public DatePickerForm clickId( String id ) throws FormException {
	...
	@Override
	public DatePickerForm clickXPath( String xpath ) throws FormException {
...
*/	
/*	@Override
	public DatePickerForm selectByXPathAndVisibleText( String xpath, String text ) throws FormException {
	...
	@Override
	public DatePickerForm typeByXPath( String xpath, String text ) throws FormException {
