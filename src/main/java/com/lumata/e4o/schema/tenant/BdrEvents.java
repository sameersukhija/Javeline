...
public class BdrEvents { 
	...
	public BdrEvents( ResultSet rs ) throws SQLException {
		...
		this.id = rs.getInt( BdrEvents.Fields.id.name() );
		this.insert_time = rs.getTimestamp( BdrEvents.Fields.insert_time.name() );
	...
	public BdrEvents( JSONObject jo ) throws JSONException, ParseException {
		...
		this.id = (int)jo.getInt( BdrEvents.Fields.id.name() );
		this.insert_time = new Timestamp( Format.getMysqlDateTime( jo.getString( BdrEvents.Fields.insert_time.name() ) ).getTime() );
