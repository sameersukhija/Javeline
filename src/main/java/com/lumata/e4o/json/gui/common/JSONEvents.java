package com.lumata.e4o.json.gui.common;
...
public class JSONEvents extends JsonElement {

	private final String JSON_ROOT_ = "events";
	
	public JSONEvents( JSONObject jsonObject ) throws JSONSException {
		
		super( jsonObject );
		
		setJsonRoot( JSON_ROOT_ );
		
		setJsonRoot( "campaigns[0].target.targetingOpened.subscriberRestrictions.events" );
		
	}
	
	public JSONEvents get( Integer index ) {
