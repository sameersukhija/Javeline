...
public class DAOTokenLabel extends DAO {

	private static final Logger logger = LoggerFactory.getLogger( DAOTokenLabel.class );
	
	SimpleDateFormat sdf;
	
	public DAOTokenLabel( Mysql mysql ) {
		super( mysql );
		sdf = new SimpleDateFormat( "yyyy-MM-dd HH:mm:ss" );
	}
	
	public static DAOTokenLabel getInstance( Mysql mysql ) {
		return new DAOTokenLabel( mysql );
	}
	
	public Boolean isTokenLabel( String label ) {
		
		TokenLabel tokenLabel = new TokenLabel();
		
		tokenLabel.setLabel( label );
		
		String query = select().from( tokenLabel ).where( op( TokenLabel.Fields.label ).eq() ).build();
	...
	public void insertLabel( String label ) {
		...
		try {
			...
			MysqlUtils.getMaxID( "token_label", TokenLabel.Fields.token_label_id.name(), this.getMysql() );
	...
	public TokenLabel getTokenLabelByLabel( String label ) {
