...
import com.lumata.expression.operators.exceptions.CDR.GeneratingType;
import com.lumata.expression.operators.generators.CDRMSISDNGenerator;

public class GenerateCDRTest {

	private static final Logger logger = LoggerFactory.getLogger( GenerateCDRTest.class );
	...
	public void generateCDRMSISDN() throws IOFileException {
		/*
		ICDRRevenue cdr = new CDRRevenue();
		
		cdr.setMsisdn(1L);
		
		CDRRevenue c = CDR.revenue();
		c.
		//cdr.setMsisdnSequence( 33999, 0, 10, 18 );
