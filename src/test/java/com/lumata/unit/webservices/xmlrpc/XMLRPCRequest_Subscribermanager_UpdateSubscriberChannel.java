...
public class XMLRPCRequest_Subscribermanager_UpdateSubscriberChannel {
	
	private static final Logger logger = LoggerFactory.getLogger( XMLRPCRequest_Subscribermanager_UpdateSubscriberChannel.class );
