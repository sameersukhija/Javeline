...
public class XMLRPCRequest_Eventmanager_GenerateCustomEvent {
	...
	public void callXMLRPCCRequest() throws Exception {
		...
		ClientResponse<String> response = XMLRPCRequestOld.badgemanager_getBadgeList.call( 	actruleServer, 
																							xmlrpcBody(
