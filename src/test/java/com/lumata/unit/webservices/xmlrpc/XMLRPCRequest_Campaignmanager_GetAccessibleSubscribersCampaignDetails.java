...
public class XMLRPCRequest_Campaignmanager_GetAccessibleSubscribersCampaignDetails {
	...
	public void callXMLRPCCRequest() throws Exception {
		...
		XMLRPCRequest.campaignmanager_getAccessibleSubscribersCampaignDetails().call( 	
			actruleServer, 
			xmlrpcBody(
