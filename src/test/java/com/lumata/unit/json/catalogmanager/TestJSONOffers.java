...
public class TestJSONOffers {

	private static final Logger logger = LoggerFactory.getLogger( TestJSONOffers.class );
	...
	public void checkJSONOffers( @Optional("tenant") String tenant ) throws JSONSException, FormException, JSONException {
		
		JSONOffers jsonOffers = new JSONOffers( "input/catalogmanager/offers", "offerList" );
		
		for( int o = 0; o < jsonOffers.getList().length(); o++ ) {
				
			jsonOffers.setOfferById( o );
			
			System.out.println( jsonOffers.getName() );
