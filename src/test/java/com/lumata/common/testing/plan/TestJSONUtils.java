...
public class TestJSONUtils {
	...
	/** The resource exists */
	@Test()
	public void loadJSONResource_1() throws JSONSException, IOFileException {		
	...
	/** The resource exists */
	@Test()
	public void saveJSONResource_1() throws JSONSException, IOFileException {		
	...
	/** The resource not exists */
	@Test()
	public void saveJSONResource_2() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	/** The resource is null */
	@Test( expectedExceptions = JSONSException.class )
	public void saveJSONResource_3() throws JSONSException, IOFileException {		
		JSONUtils.saveJSONResource( new JSONObject(), null );
	}
	
	/** The folder exists and the resource exists */
	@Test()
	public void saveJSONResource_5() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	/** The folder exists and the resource not exists */
	@Test()
	public void saveJSONResource_6() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	@Test( expectedExceptions = JSONSException.class )
	public void saveJSONResource_7() throws JSONSException, IOFileException {		
		JSONUtils.saveJSONResource( new JSONObject(), "examples", null );
	}
	
	/** The folder not exists and the resource is valid */
	@Test()
	public void saveJSONResource_9() throws JSONSException, IOFileException {		
	...
	/** The resource exists */
	@Test()
	public void saveJSONFile_1() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	/** The File not exists */
	@Test()
	public void saveJSONFile_2() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	/** The File is null */
	@Test( expectedExceptions = JSONSException.class )
	public void saveJSONFile_3() throws JSONSException, IOFileException {		
		JSONUtils.saveJSONFile( new JSONObject(), null );
	}
	
	/** The folder exists and the File exists */
	@Test()
	public void saveJSONFile_5() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	/** The folder exists and the File not exists */
	@Test()
	public void saveJSONFile_6() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	@Test( expectedExceptions = JSONSException.class )
	public void saveJSONFile_7() throws JSONSException, IOFileException {		
		JSONUtils.saveJSONFile( new JSONObject(), "examples", null );
	}
	
	/** The folder not exists and the File is valid */
	@Test()
	public void saveJSONFile_9() throws JSONSException, IOFileException {		
		JSONObject jo = JSONUtils.loadJSONResource( "e4b_qa.json" );
	...
	/** The folder is null and the File is valid */
	@Test( expectedExceptions = JSONSException.class )
	public void saveJSONFile_10() throws JSONSException, IOFileException {		
