...
public class XLRPCRequest_Catalogmanager_Allocate {
	
	private static final Logger logger = LoggerFactory.getLogger( XLRPCRequest_Catalogmanager_Allocate.class );
