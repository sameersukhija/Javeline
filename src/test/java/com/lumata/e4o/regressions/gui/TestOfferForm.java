...
//		public void send(String remote_host,String sftp_user,int port,String encryptedPassword){
//			SFTPClient sftp = new SFTPClient( remote_host, port,sftp_user,encryptedPassword );
//			
//			if( sftp.isConnected() ) {
//				String remote_path="/opt/e4osystemtest/input/catalogmanager/offers/vouchers";
//				
//				String local_path = DEFAULT_RESOURCE_FOLDER_ROOT + "input/catalogmanager/Offers/";
//				
//	            sftp.copyFile( local_path, "VoucherCodes.csv", remote_path , "VoucherCodes.csv", SFTPClient.CopyType.LOCAL_TO_REMOTE );
//	            		
//			}
//		}
