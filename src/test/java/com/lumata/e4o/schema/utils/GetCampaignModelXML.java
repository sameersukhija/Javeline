...
@TCMysqlMaster
public class GetCampaignModelXML extends ParentTestCase {

	@Test( enabled=true, priority = 1 )
	public void getCampaignXML() throws Exception {
		
		final String MODELS_XML = "models.xml";
		
		FilesMeta fm = new FilesMeta();
		fm.setName( MODELS_XML );
		...
		IOFileUtils.saveResource( xml, "campaignmanager", "models.xml" );
