...
public class ConfigureCampaignTypes {

	private static final Logger logger = LoggerFactory.getLogger( ConfigureCampaignTypes.class );
	...
	@Parameters({"campaignTypeList"})
	@Test( enabled=testEnabled, priority = 1 )
	public void configureSuppliers( @Optional("campaignTypeList") String campaignTypeList ) throws FormException, JSONException, JSONSException {
