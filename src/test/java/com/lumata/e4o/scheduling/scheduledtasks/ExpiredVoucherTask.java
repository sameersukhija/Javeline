...
public class ExpiredVoucherTask {
	...
	@Test( enabled = true )
	public void expiredVoucher( @Optional("E4O_VM") String environment,  @Optional("tenant") String tenant ) throws IOFileException, ClassNotFoundException, JSONSException, NetworkEnvironmentException {
		...
		System.out.println( ekc.execTask( 23500, 1, ExpressionKernelCommands.Task.ExpiredVoucher ) );
