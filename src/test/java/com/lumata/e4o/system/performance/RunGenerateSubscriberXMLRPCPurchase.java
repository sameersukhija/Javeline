...
public class RunGenerateSubscriberXMLRPCPurchase {
	...
	final int EXECUTION_TIME = 50000;
	...
	private void initializeThreads() {
		...
		for( int i = 0; i < N_THREADS; i++ ) {
			...
			GenerateXMLRPCPurchaseThread t = new GenerateXMLRPCPurchaseThread( ( i + 1 ), Thread.MAX_PRIORITY, THREAD_SLEEP, guiServer, superman, 3399900001L, "OFFVoucher1", "Ch A" );
			t.startThread();
