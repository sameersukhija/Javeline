package com.lumata.e4o.utils.subscribers;
...
public class SubscribersCountOffersByOffersName {

	private static final Logger logger = LoggerFactory.getLogger( SubscribersCountOffersByOffersName.class );
	...
	public void generateFixedSubscriber() throws GeneratorException {
		...
		final Long SUBSCRIBERS_TO_GENERATE = 20L;
